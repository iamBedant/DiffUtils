package com.rajsuvariya.diffutilstest.Utils;
...
//        Log.d("diffutilcheck", "Diff started "+!newContact.getName().equals(oldContact.getName())+" "+!newContact.getPhonenumber().equals(oldContact.getPhonenumber()));
